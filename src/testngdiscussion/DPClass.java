...
//		To locate the sheet
		...
		String[][] data = new String[rowcount][columncount] ;//definig two diamsional array define string
//row cont and coloum count milnar

		for(int i=0; i<rowcount; i++)
		{
			for(int j=0; j<columncount; j++)
			{
				 data[i][j]= sh1.getRow(i).getCell(j).getStringCellValue();//matrix 0row 0column
