...
public class ExcelReader 
{
	...
	{
		String path = System.getProperty("user.dir")+"\\Worksheet.xlsx";
...
//			To locate the row and column
			...
			int rowcount = sh1.getLastRowNum()+1;//total row jar phije asel tar+1 karyache
...
//Assignment: WAP to read all values from Excel sheet use for loop i j